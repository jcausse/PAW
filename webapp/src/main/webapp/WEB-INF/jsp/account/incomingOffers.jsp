    ...
    <c:choose>
        ...
        <c:otherwise>
            ...
            <c:if test="${not empty resolvedOffers}">
                <h2 class="text-lg font-semibold mb-4"><c:out value="${resolvedTitleMsg}"/></h2>
                <div class="overflow-x-auto">
                    <table class="w-full text-left">
                        <thead>
                            <tr class="border-b border-black/10">
                                <th class="pb-2 font-medium text-black/70"><spring:message code="account.incomingOffers.table.listing"/></th>
                                <th class="pb-2 font-medium text-black/70"><spring:message code="account.incomingOffers.table.buyer"/></th>
                                <th class="pb-2 font-medium text-black/70"><spring:message code="account.incomingOffers.table.amount"/></th>
                                <th class="pb-2 font-medium text-black/70"><spring:message code="account.incomingOffers.table.status"/></th>
                                <th class="pb-2 font-medium text-black/70"><spring:message code="account.incomingOffers.table.actions"/></th>
                            </tr>
                        </thead>
                        <tbody>
                            <c:forEach var="offer" items="${resolvedOffers}">
                                ...
                                <tr class="border-b border-black/5 last:border-0">
                                    ...
                                    <td class="py-3"><c:out value="${offer.buyer.username}"/></td>
                                    <td class="py-3 font-semibold">$<c:out value="${offer.amount}"/></td>
                                    <td class="py-3">
                                    ...
                                    <td class="py-3">
                                        <c:url value="/offer/${offer.id}" var="offerUrl"/>
                                        <spring:message code="account.incomingOffers.table.view" var="viewLabel"/>
                                        <paw:linkButton href="${offerUrl}" text="${viewLabel}" variant="outline" size="sm"/>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
